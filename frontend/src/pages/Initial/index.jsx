...
import './Styles/style.css'; // Ou o caminho correto para seu CSS, ex: './Styles/style.css'

// --- NOVOS DADOS DOS PRODUTOS (TechNova) ---
const allProductsData = [
  {
    id: 'tech001', // Adicionando IDs únicos
    ...
    preco: 39.99,
    quantidade: 27,
    imagens: [ "https://i.ibb.co/zhRPrqQS/01.jpg", "https://i.ibb.co/Vp0B2h2m/02.jpg", "https://i.ibb.co/nqXtTqG4/03.jpg" ]
  },
  {
    id: 'tech002',
    nome: "Mouse Gamer",
    textoDescritivo: "Mouse Gamer Óptico Nitro 7200 DPI, 6 Botões, USB",
    cor: "Preto",
    fabricante: "Acer",
    preco: 79.99,
    quantidade: 18,
    imagens: [ "https://i.ibb.co/60gSPfDP/01.jpg", "https://i.ibb.co/prfqF9fM/02.jpg", "https://i.ibb.co/tTx9zdtd/03.jpg" ]
  },
  {
    id: 'tech003',
    nome: "HeadSet",
    textoDescritivo: "HeadSet Gamer com Microfone Quantum II, P3",
    cor: "Preto",
    fabricante: "JBL",
    preco: 119.99,
    quantidade: 19,
    imagens: [ "https://i.ibb.co/xqz36nXW/01.jpg", "https://i.ibb.co/k6zsq6VW/03.jpg", "https://i.ibb.co/wNBdSfg5/02.jpg" ]
  },
  {
    id: 'tech004',
    nome: "Teclado Gamer",
    textoDescritivo: "Teclado Mecânico Gamer Phantom, ABNT2",
    cor: "Preto",
    fabricante: "Fortrek",
    preco: 99.99,
    quantidade: 12,
    imagens: [ "https://i.ibb.co/9zDbk1w/01.jpg", "https://i.ibb.co/0j0gTT5H/02.jpg", "https://i.ibb.co/DHCSqKsd/03.jpg" ]
  },
  {
    id: 'tech005',
    nome: "Fone Bluetooth",
    textoDescritivo: "Fone de Ouvido Tune Buds, Bluetooth",
    cor: "Preto",
    fabricante: "JBL",
    preco: 389.9,
    quantidade: 3,
    imagens: [ "https://i.ibb.co/pB2hLd9R/03.jpg", "https://i.ibb.co/3mSRMSgd/02.jpg", "https://i.ibb.co/ch0hNMsv/04.jpg" ]
  },
  {
    id: 'tech006',
    nome: "Teclado Slim",
    textoDescritivo: "Teclado Membrana Fortrek K15, ABNT2, USB",
    cor: "Preto",
    fabricante: "Fortrek",
    preco: 89.99,
    quantidade: 11,
    imagens: [ "https://i.ibb.co/G4BR1Sds/03.jpg", "https://i.ibb.co/wZr6MgWB/02.jpg", "https://i.ibb.co/tTYkZ85S/01.jpg" ]
  },
  {
    id: 'tech007',
    nome: "Mouse HX",
    textoDescritivo: "Mouse Pulsefire Haste 2 Mini, 26000dpi, 6 Botões, Wireless",
    cor: "Preto",
    fabricante: "Hyperx",
    preco: 379.99,
    quantidade: 5,
    imagens: [ "https://i.ibb.co/Zp3rKKBQ/01.jpg", "https://i.ibb.co/fzhyhJfc/02.jpg", "https://i.ibb.co/nskSxbrP/03.jpg" ]
  },
  {
    id: 'tech008',
    nome: "Fone Wireless",
    textoDescritivo: "Fone de Ouvido Tune Flex, Wireless",
    cor: "Preto",
    fabricante: "JBL",
    preco: 439.99,
    quantidade: 14,
    imagens: [ "https://i.ibb.co/JjM8Kn9B/02.jpg", "https://i.ibb.co/XrWMYMZj/03.jpg", "https://i.ibb.co/ksHzyn0Q/01.jpg" ]
  },
  {
    id: 'tech009',
    nome: "Teclado Slim Branco", // Nome diferenciado para o segundo teclado Slim
    textoDescritivo: "Teclado Membrana Fortrek K15, ABNT2, USB",
    cor: "Branco",
    fabricante: "Fortrek",
    preco: 105.99,
    quantidade: 8,
    imagens: [ "https://i.ibb.co/RGDt1tQG/03.jpg", "https://i.ibb.co/wrsf52qB/02.jpg", "https://i.ibb.co/XfcFtrCH/01.jpg" ]
  },
  {
    id: 'tech010',
    nome: "Mouse King Vermelho",
    textoDescritivo: "Mouse King Pro Horda World of Warcraft, 26000dpi, 5 Botões",
    cor: "Vermelho",
    fabricante: "Redragon",
    preco: 329.99,
    quantidade: 6,
    imagens: [ "https://i.ibb.co/NnGDKpRD/04.jpg", "https://i.ibb.co/8DJncPDX/02.jpg", "https://i.ibb.co/wN0tr7sk/01.jpg" ]
  },
  {
    id: 'tech011',
    nome: "Fone Pure Bass",
    textoDescritivo: "Fone de Ouvido Tune 500 Pure Bass, P2",
    cor: "Branco",
    fabricante: "JBL",
    preco: 139.99,
    quantidade: 12,
    imagens: [ "https://i.ibb.co/LdwJHxtZ/01.jpg", "https://i.ibb.co/GQ4T0xTd/03.jpg", "https://i.ibb.co/gFXrgBLk/02.jpg" ]
  },
  {
    id: 'tech012',
    ...
    preco: 319.99,
    quantidade: 8,
    imagens: [ "https://i.ibb.co/R47938fc/01.jpg", "https://i.ibb.co/fV3CvpfR/02.jpg", "https://i.ibb.co/ccdSz1n9/03.jpg" ]
  }
];
...
const ProductImage = ({ src, alt, className = '' }) => {
  // Tenta manter uma proporção se a imagem quebrar ou não carregar
  // Para imagens reais, o CSS pode precisar de object-fit
  return (
...
const ProductCard = ({ product, showPrice = true, size = 'default' }) => {
  ...
  return (
    <div className={cardClass}>
      <div className="product-image-wrapper">
        <ProductImage
          src={product.imagens[0]} // Usa a primeira imagem do array
          alt={product.nome}
        />
      </div>
      <p className="product-name">{product.nome}</p>
      {showPrice && product.preco && <p className="product-price">R$ {product.preco.toFixed(2).replace('.', ',')}</p>}
    </div>
  );
};
...
function App() {
  // Lógica para Produtos em Destaque (anterior New Collection)
  const FEATURED_PRODUCTS_COUNT = 2;
  const [featuredCurrentIndex, setFeaturedCurrentIndex] = useState(0);
  const featuredProductsData = allProductsData.slice(0, 6); // Pega os primeiros 6 para rotacionar

  const handleFeaturedNext = () => {
    setFeaturedCurrentIndex(prevIndex =>
      Math.min(prevIndex + FEATURED_PRODUCTS_COUNT, featuredProductsData.length - FEATURED_PRODUCTS_COUNT)
    );
  };
  const handleFeaturedPrev = () => {
    setFeaturedCurrentIndex(prevIndex => Math.max(prevIndex - FEATURED_PRODUCTS_COUNT, 0));
  };
  ...
  // Lógica para Novidades (anterior New This Week)
  const NEW_ARRIVALS_COUNT = 4;
  const [newArrivalsCurrentIndex, setNewArrivalsCurrentIndex] = useState(0);
  // Pega os próximos produtos após os destacados, ou um conjunto fixo
  const newArrivalsData = allProductsData.slice(2, 10); // Exemplo: pega do 3º ao 10º produto

  const handleNewArrivalsNext = () => {
    setNewArrivalsCurrentIndex(prevIndex =>
      Math.min(prevIndex + NEW_ARRIVALS_COUNT, newArrivalsData.length - NEW_ARRIVALS_COUNT)
    );
  };
  const handleNewArrivalsPrev = () => {
    setNewArrivalsCurrentIndex(prevIndex => Math.max(prevIndex - NEW_ARRIVALS_COUNT, 0));
  };
  ...
  // Lógica para Navegue por Marcas (anterior XIV Collections)
  const ITEMS_PER_BRAND_PAGE = 3;
  const brands = [...new Set(allProductsData.map(p => p.fabricante))]; // Pega marcas únicas
  const [activeBrandFilter, setActiveBrandFilter] = useState('All');
  const [brandDisplayedCount, setBrandDisplayedCount] = useState(ITEMS_PER_BRAND_PAGE);

  const filteredByBrandProducts = allProductsData.filter(product =>
    activeBrandFilter === 'All' ? true : product.fabricante === activeBrandFilter
  );
  const displayedBrandProducts = filteredByBrandProducts.slice(0, brandDisplayedCount);

  const handleLoadMoreBrand = () => {
    setBrandDisplayedCount(prevCount => Math.min(prevCount + ITEMS_PER_BRAND_PAGE, filteredByBrandProducts.length));
  };
